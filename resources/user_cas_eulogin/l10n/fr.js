OC.L10N.register(
    "user_cas",
    {
        "EULOGIN Authentication backend": "Authentification EULOGIN",
        ...
        "Disable CAS logout (do only Asset Manager logout)": "Désactiver la déconnexion CAS (déconnexion d'Asset Manager uniquement)",
        ...
        "Groups that will not be unlinked from the user when sync the CAS server and the Asset Manager": "Groupes de l'utilisateur qui seront pas supprimés lors de la synchronisation entre le serveur CAS et Asset Manager",
        ...
        "Default group when autocreating users": "Groupe par défaut lors de la création automatique des utilisateurs Asset Manager",
        "Authorized CAS Groups": "Groupes autorisés CAS",
        "Users in the following groups will be able to log into Asset Manager, users not in one of the groups will be logged out immediately": "Les utilisateurs des groupes suivants pourront se connecter à Asset Manager, les utilisateurs ne faisant pas partie d'un groupe seront déconnectés immédiatement",
